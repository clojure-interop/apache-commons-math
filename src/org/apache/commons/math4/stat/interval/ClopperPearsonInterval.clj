(ns org.apache.commons.math4.stat.interval.ClopperPearsonInterval
...
(defn create-interval
  ...
  (^org.apache.commons.math4.stat.interval.ConfidenceInterval [^ClopperPearsonInterval this ^Integer number-of-trials ^Integer number-of-successes ^Double confidence-level]
