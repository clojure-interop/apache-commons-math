(ns org.apache.commons.math4.linear.AbstractRealMatrix
...
(defn scalar-add
  ...
  (^org.apache.commons.math4.linear.RealMatrix [^AbstractRealMatrix this ^Double d]
    (-> this (.scalarAdd d))))
...
(defn pre-multiply
  ...
  (^org.apache.commons.math4.linear.RealMatrix [^AbstractRealMatrix this ^org.apache.commons.math4.linear.RealMatrix m]
    (-> this (.preMultiply m))))
...
(defn set-row-vector
  ...
  ([^AbstractRealMatrix this ^Integer row ^org.apache.commons.math4.linear.RealVector vector]
...
(defn create-matrix
  ...
  (^org.apache.commons.math4.linear.RealMatrix [^AbstractRealMatrix this ^Integer row-dimension ^Integer column-dimension]
...
(defn get-column-matrix
  ...
  (^org.apache.commons.math4.linear.RealMatrix [^AbstractRealMatrix this ^Integer column]
...
(defn get-trace
  ...
  (^Double [^AbstractRealMatrix this]
    (-> this (.getTrace))))
...
(defn get-column-dimension
  ...
  (^Integer [^AbstractRealMatrix this]
...
(defn copy
  ...
  (^org.apache.commons.math4.linear.RealMatrix [^AbstractRealMatrix this]
    (-> this (.copy))))
...
(defn get-column
  ...
  ([^AbstractRealMatrix this ^Integer column]
...
(defn get-entry
  ...
  (^Double [^AbstractRealMatrix this ^Integer row ^Integer column]
...
(defn square?
  ...
  (^Boolean [^AbstractRealMatrix this]
    (-> this (.isSquare))))
...
(defn walk-in-optimized-order
  ...
  (^Double [^AbstractRealMatrix this ^org.apache.commons.math4.linear.RealMatrixChangingVisitor visitor ^Integer start-row ^Integer end-row ^Integer start-column ^Integer end-column]
    (-> this (.walkInOptimizedOrder visitor start-row end-row start-column end-column)))
  (^Double [^AbstractRealMatrix this ^org.apache.commons.math4.linear.RealMatrixChangingVisitor visitor]
...
(defn to-string
  ...
  (^java.lang.String [^AbstractRealMatrix this]
    (-> this (.toString))))
...
(defn get-column-vector
  ...
  throws: org.apache.commons.math4.exception.OutOfRangeException - if the specified column index is invalid"
  (^org.apache.commons.math4.linear.RealVector [^AbstractRealMatrix this ^Integer column]
...
(defn get-sub-matrix
  ...
  throws: org.apache.commons.math4.exception.OutOfRangeException - if the indices are not valid."
  (^org.apache.commons.math4.linear.RealMatrix [^AbstractRealMatrix this ^Integer start-row ^Integer end-row ^Integer start-column ^Integer end-column]
    (-> this (.getSubMatrix start-row end-row start-column end-column)))
  (^org.apache.commons.math4.linear.RealMatrix [^AbstractRealMatrix this selected-rows selected-columns]
...
(defn power
  ...
  (^org.apache.commons.math4.linear.RealMatrix [^AbstractRealMatrix this ^Integer p]
    (-> this (.power p))))
...
(defn set-column
  ...
  throws: org.apache.commons.math4.exception.OutOfRangeException - if the specified column index is invalid."
  ([^AbstractRealMatrix this ^Integer column array]
...
(defn set-row
  ...
  throws: org.apache.commons.math4.exception.OutOfRangeException - if the specified row index is invalid."
  ([^AbstractRealMatrix this ^Integer row array]
...
(defn set-row-matrix
  ...
  throws: org.apache.commons.math4.exception.OutOfRangeException - if the specified row index is invalid."
  ([^AbstractRealMatrix this ^Integer row ^org.apache.commons.math4.linear.RealMatrix matrix]
...
(defn set-column-matrix
  ...
  throws: org.apache.commons.math4.exception.OutOfRangeException - if the specified column index is invalid."
  ([^AbstractRealMatrix this ^Integer column ^org.apache.commons.math4.linear.RealMatrix matrix]
...
(defn get-row
  ...
  ([^AbstractRealMatrix this ^Integer row]
    (-> this (.getRow row))))
...
(defn get-row-vector
  ...
  throws: org.apache.commons.math4.exception.OutOfRangeException - if the specified row index is invalid."
  (^org.apache.commons.math4.linear.RealVector [^AbstractRealMatrix this ^Integer row]
...
(defn set-entry
  ...
  throws: org.apache.commons.math4.exception.OutOfRangeException - if the row or column index is not valid"
  ([^AbstractRealMatrix this ^Integer row ^Integer column ^Double value]
...
(defn add-to-entry
  ...
  throws: org.apache.commons.math4.exception.OutOfRangeException - if the row or column index is not valid."
  ([^AbstractRealMatrix this ^Integer row ^Integer column ^Double increment]
...
(defn multiply-entry
  ...
  throws: org.apache.commons.math4.exception.OutOfRangeException - if the row or column index is not valid."
  ([^AbstractRealMatrix this ^Integer row ^Integer column ^Double factor]
...
(defn copy-sub-matrix
  ...
  throws: org.apache.commons.math4.exception.OutOfRangeException - if the indices are not valid."
  ([^AbstractRealMatrix this ^Integer start-row ^Integer end-row ^Integer start-column ^Integer end-column destination]
    (-> this (.copySubMatrix start-row end-row start-column end-column destination)))
  ([^AbstractRealMatrix this selected-rows selected-columns destination]
...
(defn get-row-matrix
  ...
  throws: org.apache.commons.math4.exception.OutOfRangeException - if the specified row index is invalid."
  (^org.apache.commons.math4.linear.RealMatrix [^AbstractRealMatrix this ^Integer row]
...
(defn equals
  ...
  (^Boolean [^AbstractRealMatrix this ^java.lang.Object object]
    (-> this (.equals object))))
...
(defn set-sub-matrix
  ...
  ([^AbstractRealMatrix this sub-matrix ^Integer row ^Integer column]
...
(defn set-column-vector
  ...
  throws: org.apache.commons.math4.exception.OutOfRangeException - if the specified column index is invalid."
  ([^AbstractRealMatrix this ^Integer column ^org.apache.commons.math4.linear.RealVector vector]
