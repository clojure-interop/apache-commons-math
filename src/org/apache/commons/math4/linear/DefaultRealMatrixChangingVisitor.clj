(ns org.apache.commons.math4.linear.DefaultRealMatrixChangingVisitor
...
(defn ->default-real-matrix-changing-visitor
  "Constructor."
...
(defn start
  ...
  ([^DefaultRealMatrixChangingVisitor this ^Integer rows ^Integer columns ^Integer start-row ^Integer end-row ^Integer start-column ^Integer end-column]
...
(defn visit
  ...
  (^Double [^DefaultRealMatrixChangingVisitor this ^Integer row ^Integer column ^Double value]
...
(defn end
  ...
  (^Double [^DefaultRealMatrixChangingVisitor this]
    (-> this (.end))))
