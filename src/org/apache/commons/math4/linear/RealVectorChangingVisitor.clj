(ns org.apache.commons.math4.linear.RealVectorChangingVisitor
...
(defn start
  ...
  ([^RealVectorChangingVisitor this ^Integer dimension ^Integer start ^Integer end]
...
(defn visit
  ...
  returns: the new value of the entry being visited - `double`"
  (^Double [^RealVectorChangingVisitor this ^Integer index ^Double value]
...
(defn end
  ...
  returns: the value returned by
   RealVector.walkInDefaultOrder(RealVectorChangingVisitor),
   RealVector.walkInDefaultOrder(RealVectorChangingVisitor, int, int),
   RealVector.walkInOptimizedOrder(RealVectorChangingVisitor)
   or
   RealVector.walkInOptimizedOrder(RealVectorChangingVisitor, int, int) - `double`"
  (^Double [^RealVectorChangingVisitor this]
    (-> this (.end))))
