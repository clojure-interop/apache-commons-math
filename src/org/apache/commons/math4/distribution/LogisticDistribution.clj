(ns org.apache.commons.math4.distribution.LogisticDistribution
...
(defn support-connected?
  ...
  (^Boolean [^LogisticDistribution this]
...
(defn inverse-cumulative-probability
  ...
  (^Double [^LogisticDistribution this ^Double p]
...
(defn density
  ...
  (^Double [^LogisticDistribution this ^Double x]
    (-> this (.density x))))
