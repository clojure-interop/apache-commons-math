(ns org.apache.commons.math4.distribution.LaplaceDistribution
...
(defn support-connected?
  ...
  (^Boolean [^LaplaceDistribution this]
...
(defn inverse-cumulative-probability
  ...
  (^Double [^LaplaceDistribution this ^Double p]
...
(defn density
  ...
  (^Double [^LaplaceDistribution this ^Double x]
    (-> this (.density x))))
